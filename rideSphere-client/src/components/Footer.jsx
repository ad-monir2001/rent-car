...
const Footer = () => {
  return (
    <footer className="footer bg-[#040401] text-white footer-center p-10">
      <aside>
        <Link
        ...
        <p className="font-bold font-body">
          Drive Your Journey, Shape Your Experience.
        </p>
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          ...
          <Link to="https://www.facebook.com/mdmoniruzzaman.monir.73700/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
